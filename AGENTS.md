...
- Keep `AGENTS.md`, linked docs (recursively), and `llms.txt` current when repository guidance, public API, DSL behavior, adapter usage, errors, or canonical examples change; if no update is needed, record why.
